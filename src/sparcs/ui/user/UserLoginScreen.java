...
public class UserLoginScreen {
    ...
    public static JPanel build(CardLayout cardLayout, JPanel rootPanel, AppState state) {
        ...
        cc.gridy = 0; cc.insets = new Insets(0, 0, 18, 0);
        JLabel sub = UIFactory.lbl("Vehicle Owner Portal", Font.BOLD, 20, C_ACCENT);
        sub.setHorizontalAlignment(SwingConstants.CENTER);
        card.add(sub, cc);

        cc.gridy = 1; cc.insets = new Insets(4, 0, 2, 0);
        ...
        cc.gridy = 5; cc.insets = new Insets(18, 0, 6, 0);
        ...
        cc.gridy = 8; cc.insets = new Insets(8, 0, 0, 0);
        card.add(backBtn, cc);
